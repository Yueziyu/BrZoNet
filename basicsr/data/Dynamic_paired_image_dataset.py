    ...
    def __call__(self, hr_tensor, random=True):
        with torch.no_grad():
            ...
            if self.mode == 'bicubic':
                ...
                lr_blured = hr_blured.view(B, C, H//self.scale, self.scale, W//self.scale, self.scale)[:, :, :, 0, :, 0]
...
# Dataset
class Dataset_Dynamic_PairedImage(data.Dataset):
    ...
    def __init__(self, opt):
        super(Dataset_Dynamic_PairedImage, self).__init__()
        self.opt = opt
